...
学习深度学习项目：debug源码、可以结合 debug 和 pysnooper 看某一个具体函数功能、读论文、pycharm 按 Ctrl 跳转源码、跳转以后可以使用 pysnooper、debug 有问题去 GitHub 的 issue 里去搜  

出现错误可以用 pysnooper，比如安装错误，pysnooper 除了学习，还可以 debug 错误  
