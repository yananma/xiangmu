...
每次 debug 之前，读函数名，要读出来，脑海中有一幅地图，知道跳到了哪一个类里，哪一个函数下    

有一遍要读完所有的注释，在对函数名已经比较熟悉的时候    

先跟着老师的视频把代码过 5 遍再说；然后再看知识点讲解；让后再看论文  

好好学，如果妥协了，就要白白耽误一年时间，不可挽回的巨大损失，现在这种是做好的，对未来发展最有利，也是最容易的做法  

别的做不到，debug 20 遍还做不到吗？一路点击就行了，已经容易百倍了，先做到再说别的  

5 个项目，每个项目 15 个重要函数，一天用 pysnooper 弄明白 3 个，25 天，到北京学 15 天。就是背也要学会  

第二遍，只看项目视频，认识函数，总体上知道函数的功能  
